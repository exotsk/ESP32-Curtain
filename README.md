...
См. [`OPTIMIZATION_NOTES.md`](OPTIMIZATION_NOTES.md) для полной информации.
...
- Веб-Интерфейс: [`WEB_INTERFACE.md`](WEB_INTERFACE.md)
- Полная Настройка: [`QUICK_START.md`](QUICK_START.md)
...
См. [`QUICK_START.md`](QUICK_START.md) для подробной диагностики.

## 📚 Документация

- [`WEB_INTERFACE.md`](WEB_INTERFACE.md) - **НОВОЕ!** Руководство по веб-интерфейсу
- [`QUICK_START.md`](QUICK_START.md) - Руководство по установке и использованию
- [`OPTIMIZATION_NOTES.md`](OPTIMIZATION_NOTES.md) - Технические детали всех оптимизаций
